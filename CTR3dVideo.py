...
if __name__ == '__main__':
    ...
    outCam1 = cv2.VideoWriter('undistRect1.avi', fourcc, 20.0, (640,480), True)
    outCam2 = cv2.VideoWriter('undistRect2.avi', fourcc, 20.0, (640,480), True)
    ...
    ###############################################################################################
        ...
        ret, undistRectThresh1 = cv2.threshold(undistRect1, 108, 255, cv2.THRESH_BINARY)
        ...
        undistRectThresh1 = undistRectThresh1[130:410, :]
        undistRectThresh2 = undistRectThresh2[130:410, :]
        ...
        undistRect1 = undistRect1[130:410, :]

        undistRect2 = cv2.cvtColor(undistRect2, cv2.COLOR_GRAY2BGR)
        undistRect2 = undistRect2[130:410, :]
        ...
        t = ' ' + str(np.round(np.sqrt((x[0] - x[3])**2 + (y[0] - y[3])**2 + (z[0] - z[3])**2), 2))
        ...
        outCam1.write(undistRect1)
        outCam2.write(undistRect2)
        if cv2.waitKey(1) & 0xFF == ord('q'):          #if q is pressed, close window
            break

# ani.save('CTR.gif',writer='imagemagick')
cap1.release()
