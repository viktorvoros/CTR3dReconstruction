...
def find3dCoords(xyL, xyR):
    ...
    # z = z - z[0]
    # print(z)
    # coordinates in mm in world coordinate frame
    X = x*Z/f
    Y = y*Z/f
    ...
    # ax.scatter(X-X[0], Y-Y[0], Z-Z[0], c = c, marker = 'o')
    # ax.set_xlabel('X [mm]')
    # ax.set_ylabel('Y [mm]')
    # ax.set_zlabel('Z [mm]')
    # # ax.set_xlim(0, 640)
...
if __name__ == '__main__':
    ...
    # loading images
    img1 = cv2.imread('Cam1_10.jpg')
    img2 = cv2.imread('Cam2_10.jpg')
    ...
    # plt.imshow(undistRect1)
    # plt.show()
    # plt.imshow(undistRect2)
    # plt.show()
